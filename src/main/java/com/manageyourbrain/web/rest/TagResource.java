...
/**
 * REST controller for managing {@link com.manageyourbrain.domain.Tag}.
 */
@RestController
        ...
        Optional<Tag> result = tagRepository
            ...
            .map(existingTag -> {
                ...
                if (tag.getCreationDate() != null) {
                    existingTag.setCreationDate(tag.getCreationDate());
                }
                if (tag.getModifiedDate() != null) {
                    existingTag.setModifiedDate(tag.getModifiedDate());
                }
