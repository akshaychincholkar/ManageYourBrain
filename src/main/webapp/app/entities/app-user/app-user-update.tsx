  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="manageYourBrainApp.appUser.home.createOrEditLabel" data-cy="AppUserCreateUpdateHeading">
            <Translate contentKey="manageYourBrainApp.appUser.home.createOrEditLabel">Create or edit a AppUser</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  readOnly
                  id="app-user-id"
                  label={translate('manageYourBrainApp.appUser.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField
                label={translate('manageYourBrainApp.appUser.name')}
                id="app-user-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('manageYourBrainApp.appUser.email')}
                id="app-user-email"
                name="email"
                data-cy="email"
                type="text"
