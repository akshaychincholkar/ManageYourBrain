...
export const AppUserDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="manageYourBrainApp.appUser.delete.question">
        <Translate contentKey="manageYourBrainApp.appUser.delete.question" interpolate={{ id: appUserEntity.id }}>
