...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './mnemonic.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MNEMONIC_LIST actions', async () => {
    ...
    it('dispatches FETCH_MNEMONIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MNEMONIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MNEMONIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MNEMONIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MNEMONIC actions', async () => {
      const expectedActions = [
        {
