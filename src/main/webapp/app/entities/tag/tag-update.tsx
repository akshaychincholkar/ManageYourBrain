...
export const TagUpdate = () => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...tagEntity,
          creationDate: convertDateTimeFromServer(tagEntity.creationDate),
          modifiedDate: convertDateTimeFromServer(tagEntity.modifiedDate),
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="manageYourBrainApp.tag.home.createOrEditLabel" data-cy="TagCreateUpdateHeading">
            <Translate contentKey="manageYourBrainApp.tag.home.createOrEditLabel">Create or edit a Tag</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  readOnly
                  id="tag-id"
                  label={translate('manageYourBrainApp.tag.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField
                label={translate('manageYourBrainApp.tag.name')}
                id="tag-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('manageYourBrainApp.tag.creationDate')}
                id="tag-creationDate"
                name="creationDate"
              ...
              />
              <ValidatedField
                label={translate('manageYourBrainApp.tag.modifiedDate')}
                id="tag-modifiedDate"
                name="modifiedDate"
