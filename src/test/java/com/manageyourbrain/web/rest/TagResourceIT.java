...
import com.manageyourbrain.domain.Tag;
import com.manageyourbrain.repository.TagRepository;
...
class TagResourceIT {
    ...
    public static Tag createEntity(EntityManager em) {
        Tag tag = new Tag().name(DEFAULT_NAME).creationDate(DEFAULT_CREATION_DATE).modifiedDate(DEFAULT_MODIFIED_DATE);
        return tag;
    }
    ...
    public static Tag createUpdatedEntity(EntityManager em) {
        Tag tag = new Tag().name(UPDATED_NAME).creationDate(UPDATED_CREATION_DATE).modifiedDate(UPDATED_MODIFIED_DATE);
        return tag;
    }
    ...
    void putExistingTag() throws Exception {
        ...
        updatedTag.name(UPDATED_NAME).creationDate(UPDATED_CREATION_DATE).modifiedDate(UPDATED_MODIFIED_DATE);
    ...
    void partialUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.modifiedDate(UPDATED_MODIFIED_DATE);
    ...
    void fullUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.name(UPDATED_NAME).creationDate(UPDATED_CREATION_DATE).modifiedDate(UPDATED_MODIFIED_DATE);
