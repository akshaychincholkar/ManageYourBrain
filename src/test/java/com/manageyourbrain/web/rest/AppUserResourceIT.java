...
class AppUserResourceIT {
    ...
    public static AppUser createEntity(EntityManager em) {
        AppUser appUser = new AppUser().name(DEFAULT_NAME).email(DEFAULT_EMAIL);
        return appUser;
    }
    ...
    public static AppUser createUpdatedEntity(EntityManager em) {
        AppUser appUser = new AppUser().name(UPDATED_NAME).email(UPDATED_EMAIL);
        return appUser;
    }
    ...
    void putExistingAppUser() throws Exception {
        ...
        updatedAppUser.name(UPDATED_NAME).email(UPDATED_EMAIL);
    ...
    void fullUpdateAppUserWithPatch() throws Exception {
        ...
        partialUpdatedAppUser.name(UPDATED_NAME).email(UPDATED_EMAIL);
